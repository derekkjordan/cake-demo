...
<?php if ($wannaUseSession): ?>
				$this->_successFlash(__('The <?php echo strtolower($singularHumanName); ?> has been saved.'));
				return $this->redirect(array('action' => 'index'));
			}
			else
			{
				$this->_errorFlash(__('The <?php echo strtolower($singularHumanName); ?> could not be saved. Please, try again.'));
<?php else: ?>
 ...
 */
	public function <?php echo $admin; ?>delete($id = null)
	{
		...
		{
<?php if ($wannaUseSession): ?>
			$this->_successFlash(__('The <?php echo strtolower($singularHumanName); ?> has been deleted.'));
		}
		else
		{
			$this->_errorFlash(__('The <?php echo strtolower($singularHumanName); ?> could not be deleted. Please, try again.'));
		}
		return $this->redirect(array('action' => 'index'));
<?php else: ?>
